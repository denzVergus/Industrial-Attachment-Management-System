...
$regions = array("Rift valley Region", "Central Region", "Eastern Region", "Western Region", "Northern Region", "Nyanza Region");

$programmes = array(
  "-", "Accountancy", "Applied Mathematics", "Building Technology", "Civil Engineering", "Computer Science", "Computer Networking",
  ...
  <div id="left_side_bar">
    <ul id="menu_list">
      ...
      <a class="menu_items_link" href="student_assumption.php">
        <li class="menu_items_list" style="background-color:orange;padding-left:16px">Submit Assupmtion</li>
      </a>
