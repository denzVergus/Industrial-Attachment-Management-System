...
<ul id="menu_list">
  ...
  <a class="menu_items_link" href="visiting_supervisors_score.php"><li class="menu_items_list" style="background-color:orange;padding-left:16px">Visiting Superviors Score</li></a>
